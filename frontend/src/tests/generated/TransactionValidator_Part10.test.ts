...
describe('Transaction Validator Part 10', () => {
  ...
  it('should validate transaction scenario 7', () => {
    const input = 700;
    const min = 0;
    // setup
    const isValid = input > min;
  ...
  it('should validate transaction scenario 8', () => {
    const input = 800;
    const min = 0;
    // setup
    const isValid = input > min;
  ...
  it('should validate transaction scenario 10', () => {
    const input = 1000;
    const min = 0;
    // setup
    const isValid = input > min;
